...
class SnacConfig:
    audio_vocab_size = 6561
    padded_vocab_size = 6561+64
    end_of_audio = 6561
    padding_token = 6562
...
def layershift(input_id, layer, stride=snac_config.padded_vocab_size, shift=152000):
    return input_id + shift + layer * stride

def simple_shift(input_id, layer, stride=snac_config.padded_vocab_size, shift=152000):
